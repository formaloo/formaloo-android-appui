...
import co.formaloo.remote.boards.BoardsService
...
//            .baseUrl(baseUrl)
    ...
    factory(named(remoteBoardsModulConstant.DataSourceName)) { BoardsDatasource(get(named(remoteBoardsModulConstant.ServiceName))) }
}
