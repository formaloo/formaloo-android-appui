package co.formaloo.remote.boards
...
class BoardsDatasource(private val service: BoardsService) {
    ...
    suspend    fun getSharedBlockContentFlow(shared_board_slug: String,block_slug: String,        field_Choice: Map<String, Any>?) = service.getSharedBlockContentFlow(shared_board_slug,block_slug,field_Choice)
