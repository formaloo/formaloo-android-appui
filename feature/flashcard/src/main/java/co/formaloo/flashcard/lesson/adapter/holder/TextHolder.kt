...
import co.formaloo.flashcard.databinding.LayoutFlashCardEdtItemBinding
...
class TextHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    private fun checkDataValueType(edt: TextInputEditText, item: co.formaloo.model.form.Fields) {
