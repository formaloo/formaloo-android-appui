package co.formaloo.flashcard.viewmodel
...
import co.formaloo.model.form.createForm.CreateFormData
...
class UIViewModel(private val repository: FormzRepo) : BaseViewModel() {
    ...
    fun getCityFieldChoices() =viewModelScope.launch {
        ...
        val result =
            async(Dispatchers.IO) { repository.cityFieldChoices(fieldSlug, cityQuery) }.await()
    ...
    fun requestPhoneVerification() =viewModelScope.launch {
        ...
        val result =
            async(Dispatchers.IO) { repository.requestPhoneVerification(requestPhoneVerifiyReq) }.await()
    ...
    fun resendPhoneVerification() =viewModelScope.launch {
        Timber.e("requestPhoneVerification ")
        val result =
            async(Dispatchers.IO) { repository.resendPhoneVerification(uuid) }.await()
    ...
    fun verifyPhoneVerification() =viewModelScope.launch {
        ...
        val result =
            async(Dispatchers.IO) {
                repository.verifyPhoneVerification(
                    uuid,
    ...
    fun initFormAddress(formAddress: String) {
