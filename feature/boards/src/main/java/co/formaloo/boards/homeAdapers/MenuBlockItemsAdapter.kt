...
import co.formaloo.boards.databinding.LayoutBlockItemBinding
import co.formaloo.boards.databinding.LayoutGroupBlockItemBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            TYPE_GROUP -> {
                itemView =
                    LayoutInflater.from(parent.context)
                        .inflate(R.layout.layout_group_block_item, parent, false)
...
class MenuItemBlockHolder(view: View) : RecyclerView.ViewHolder(view) {
    val binding = LayoutBlockItemBinding.bind(view)
    ...
    fun bindItems(
        ...
        if (color !=null){
            ImageViewCompat.setImageTintList(binding.closeFullBtn,
...
class GroupHolder(view: View) : RecyclerView.ViewHolder(view) {
    val binding = LayoutGroupBlockItemBinding.bind(view)
    val context = view.context
